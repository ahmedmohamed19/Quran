...
const achievements = [
    { id: 1, name: 'اسعد محمود', img: asad, description: 'المرتبة الأولى في مسابقة الحفظ' },
    { id: 2, name: 'علي ابراهيم', img: ali, description: 'حفظ القرآن كاملًا بتقدير ممتاز' },
    { id: 3, name: 'يامن محمد', img: yamn, description: 'حفظ 10 أجزاء من القرآن الكريم' },
    { id: 4, name: 'أحمد محمود', img: ahmed, description: 'حفظ 10 أجزاء من القرآن الكريم' },
    { id: 5, name: 'صلاح الدين', img: salah, description: 'حفظ 10 أجزاء من القرآن الكريم' },
